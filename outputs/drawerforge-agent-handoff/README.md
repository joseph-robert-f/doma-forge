...
32. [`sprints/`](sprints/) — one spec per sprint, S01 to S15, plus the print records.
33. [`manifest.json`](manifest.json) — machine-readable package metadata and document inventory.
