...
| Expected size in the calibration card | `Expected width 299.5 mm and depth 199 mm.` |
| Measured 299.4 mm entered | `New X correction 0.6 mm = existing 0.5 mm + expected 299.5 mm − measured 299.4 mm` |
| After Apply | X correction 0.6, measured field empty, Apply disabled |
